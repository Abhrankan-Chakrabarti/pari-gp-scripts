#!/bin/bash
# Title:        Möbius Function Table (Verified 2-Vector Sieve with Stats)
# Description:  Computes μ(n), Mertens sum, and square-free density in a single pass.
...
GP_SCRIPT="
{
    ...
    my(mertens = 1);
    my(sq_free_count = 1); \\\\ n=1 is square-free
